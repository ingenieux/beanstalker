...
public class CreateApplicationVersionMojoTest extends BeanstalkTestBase {
	...
	protected void setUp() throws Exception {
		...
		this.testFile = new File(getBasedir(), "src/test/resources/br/com/ingenieux/mojo/beanstalk/test-war.war");
