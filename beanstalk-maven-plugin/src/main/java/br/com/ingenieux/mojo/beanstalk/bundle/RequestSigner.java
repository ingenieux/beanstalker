...
public class RequestSigner extends RequestSignerBase {
  ...
  public String getPushUrl() {
    ...
    String host = String.format("git.elasticbeanstalk.%s.amazonaws.com", region);

    String path = String.format("/v1/repos/%s/commitid/%s", hexEncode(applicationId), hexEncode(commitId));
