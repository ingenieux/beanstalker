...
public class CheckAvailabilityMojo extends AbstractBeanstalkMojo {
  ...
  protected Object executeInternal() throws MojoExecutionException, MojoFailureException {
    CheckDNSAvailabilityRequest checkDNSAvailabilityRequest = new CheckDNSAvailabilityRequest(cnamePrefix);

    CheckDNSAvailabilityResult result = getService().checkDNSAvailability(checkDNSAvailabilityRequest);
