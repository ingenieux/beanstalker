...
public class UpdateEnvironmentMojo extends AbstractNeedsEnvironmentMojo {
     ...
     *   <li>beanstalk.scalingCustomAvailabilityZones, to aws:autoscaling:asg/Custom Availability Zones</li>
     ...
     *   <li>beanstalk.availabilityZones, to aws:autoscaling:asg/Custom Availability Zones (SAME AS beanstalk.scalingCustomAvailabilityZones FOR BACKWARD COMPATIBILITY</li>
     ...
     *   <li>beanstalk.instanceType, to aws:autoscaling:launchconfiguration/InstanceType (EC2 Instance Type to Use)</li>
     ...
     *   <li>beanstalk.triggerUpperThreshold, to aws:autoscaling:trigger/UpperThreshold</li>
     ...
     *   <li>beanstalk.vpcId, to aws:ec2:vpc/VPCId</li>
     *   <li>beanstalk.vpcSubnets, to aws:ec2:vpc/Subnets</li>
     *   <li>beanstalk.vpcELBSubnets, to aws:ec2:vpc/ELBSubnets</li>
     *   <li>beanstalk.vpcELBScheme, to aws:ec2:vpc/ELBScheme</li>
     *   <li>beanstalk.vpcDBSubnets, to aws:ec2:vpc/DBSubnets</li>
     *   <li>beanstalk.vpcAssociatePublicIpAddress, to aws:ec2:vpc/AssociatePublicIpAddress</li>
     ...
     *   <li>beanstalk.automaticallyTerminateUnhealthyInstances, to aws:elasticbeanstalk:monitoring/Automatically Terminate Unhealthy Instances (true if should automatically terminate instances)</li>

     *   <li>beanstalk.notificationEndpoint, to aws:elasticbeanstalk:sns:topics/Notification Endpoint</li>
     *   <li>beanstalk.notificationProtocol, to aws:elasticbeanstalk:sns:topics/Notification Protocol</li>
     *   <li>beanstalk.notificationTopicARN, to aws:elasticbeanstalk:sns:topics/Notification Topic ARN</li>
     *   <li>beanstalk.notificationTopicName, to aws:elasticbeanstalk:sns:topics/Notification Topic Name</li>
     ...
     *   <li>beanstalk.dbEngine, to aws:rds:dbinstance/DBEngine</li>
     *   <li>beanstalk.dbEngineVersion, to aws:rds:dbinstance/DBEngineVersion</li>
     *   <li>beanstalk.dbInstanceClass, to aws:rds:dbinstance/DBInstanceClass</li>
     *   <li>beanstalk.dbPassword, to aws:rds:dbinstance/DBPassword</li>
     *   <li>beanstalk.dbSnapshotIdentifier, to aws:rds:dbinstance/DBSnapshotIdentifier</li>
     *   <li>beanstalk.dbUser, to aws:rds:dbinstance/DBUser</li>
     *   <li>beanstalk.dbMultiAZDatabase, to aws:rds:dbinstance/MultiAZDatabase</li>
