...
public class CredentialsUtil {
     ...
     * available to others in some situations. <b>The Secret Access Key is 40
     * alpha-numeric-slash-plus characters like <code>kWcrlUX5JEDGM/LtmEENI/aVmYvHNif5zB+d9+ct</code>
     * and must be kept very secret</b>. </p>
     *
