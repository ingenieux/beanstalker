...
/**
 * Display help information on mapreduce-maven-plugin.<br/>
 * Call <code>mvn mapreduce:help -Ddetail=true -Dgoal=&lt;goal-name&gt;</code> to display parameter details.
 * @author
 * @version
 * @goal help
    ...
    extends AbstractMojo
{
    ...
    private static final String PLUGIN_HELP_PATH = "/META-INF/maven/br.com.ingenieux/mapreduce-maven-plugin/plugin-help.xml";
