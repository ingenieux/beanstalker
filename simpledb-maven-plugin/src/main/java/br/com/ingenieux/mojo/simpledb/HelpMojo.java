...
/**
 * Display help information on simpledb-maven-plugin.<br/>
 * Call <code>mvn simpledb:help -Ddetail=true -Dgoal=&lt;goal-name&gt;</code> to display parameter details.
 * @author
 * @version
 * @goal help
    ...
    extends AbstractMojo
{
    ...
    private static final String PLUGIN_HELP_PATH = "/META-INF/maven/br.com.ingenieux/simpledb-maven-plugin/plugin-help.xml";
